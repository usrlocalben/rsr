...
void fillRect(rmlg::irect rect, rmlv::vec4 value, Int16Canvas& dst);
...
void downsampleRect(rmlg::irect rect, Int16Canvas& src, FloatingPointCanvas& dst);

void copyRect(rmlg::irect rect, QFloat4Canvas& src, FloatingPointCanvas& dst);
void copyRect(rmlg::irect rect, Int16Canvas& src, FloatingPointCanvas& dst);
