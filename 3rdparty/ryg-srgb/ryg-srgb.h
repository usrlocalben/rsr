/**
 * ryg's [sse2] sRGB conversion kit
...
//    __m128i temp; // temp value (on stack)
    ...
    _mm_store_si128(&temp.m, tabidx2);

    // Table lookup
    temp.u32[0] = fp32_to_srgb8_tab3[temp.u32[0]];
    temp.u32[1] = fp32_to_srgb8_tab3[temp.u32[1]];
    temp.u32[2] = fp32_to_srgb8_tab3[temp.u32[2]];
    temp.u32[3] = fp32_to_srgb8_tab3[temp.u32[3]];
    ...
    // Table finisher
    __m128i tabval = _mm_load_si128(&temp.m);
...
//    SSE_CONST4(c_lutthresh, 0x3b800000);
    ...
    _mm_store_si128(&temp.m, tabidx);

    // Table lookup
    temp.u32[0] = fp32_to_srgb8_tab4[temp.u32[0] - (127-13)*8];
    temp.u32[1] = fp32_to_srgb8_tab4[temp.u32[1] - (127-13)*8];
    temp.u32[2] = fp32_to_srgb8_tab4[temp.u32[2] - (127-13)*8];
    temp.u32[3] = fp32_to_srgb8_tab4[temp.u32[3] - (127-13)*8];
